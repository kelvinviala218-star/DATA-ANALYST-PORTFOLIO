...
### Dashboard Preview
<img width="922" height="532" alt="dashboard_preview" src="https://github.com/user-attachments/assets/10e69c6d-a6a4-4180-a84d-104723c068e5" />
<img width="917" height="528" alt="dashboard_preview1" src="https://github.com/user-attachments/assets/659bf300-f98e-49a2-ad49-9d8143497e24" />

*(Please refer to the file `hantavirus bi visual.pdf` in the repository folder for the full interactive layout and multi-page design.)*
